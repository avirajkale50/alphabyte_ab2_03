...
const PatientOTPPage = () => {
  ...
  useEffect(() => {
    const checkSession = async () => {
      ...
      try {
        const response = await axios.get(`https://wwqgb2tx-3000.inc1.devtunnels.ms/api/session-status?patientUsername=${user.username}`);
  ...
  const handleGenerateOTP = async () => {
    ...
    try {
      const response = await axios.post('https://wwqgb2tx-3000.inc1.devtunnels.ms/api/generate-otp', {
  ...
  const handleExpireSession = async () => {
    ...
    try {
      const response = await axios.post('https://wwqgb2tx-3000.inc1.devtunnels.ms/api/end-session', {
