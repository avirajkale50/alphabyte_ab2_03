...
const PatientOTPPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 flex">
      {/* Sidebar */}
        <div className="hidden md:flex w-80 bg-white shadow-lg p-6 flex-col">
          ...
          <DriveButton
            ...
            className="w-full py-4 px-4 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-200 transition-colors border border-gray-200 flex items-center justify-center"
          >
            <svg
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-green-700">
                  <p>
                    Dr. {activeSession.doctorUsername} is currently accessing
                    your medical records.
                  </p>
                  <p className="mt-1">
                    Session expires in{" "}
                    {Math.floor(activeSession.expiresIn / 60)} minutes and{" "}
                    {activeSession.expiresIn % 60} seconds.
                  </p>
                </div>
                <div className="mt-4">
                  <button
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 max-w-2xl mx-auto">
            <div className="text-center mb-6">
              ...
              <p className="text-base text-gray-600">
                Share this OTP with your doctor to grant access
              </p>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="py-3 px-4 bg-blue-600 text-white rounded-lg text-md font-medium hover:bg-blue-700 transition-colors flex items-center justify-center"
              >
                <svg
              ...
              <button
                ...
                } text-white rounded-lg text-md font-medium transition-all duration-300 flex items-center justify-center`}
              >
                {copySuccess ? (
                  <>
                    <svg
            ...
            {linkStatus.success && (
              <div className="mt-6 p-4 bg-green-100 border-l-4 border-green-500 rounded-lg shadow-md">
                ...
                <p className="mt-1 text-sm text-green-600">
                  Your folder has been linked successfully. You can now generate
                  and share OTP.
                </p>
              </div>
            )}
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center p-8 bg-white rounded-lg shadow-md max-w-md">
              ...
              <p className="mt-2 text-gray-600">
                Generate a one-time password (OTP) to allow a healthcare
                professional temporary access to your medical records.
              </p>
              <button
                onClick={handleGenerateOTP}
                className="mt-4 w-full py-3 px-4 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors shadow-sm"
              >
                Generate OTP
              </button>
            </div>
