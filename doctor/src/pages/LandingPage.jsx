      ...
      >
        ...
        <div className="absolute inset-0">
          <img
            ...
            alt="Background"
            className="w-full h-full object-fit filter brightness-100"
          />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-8 shadow-sm hover:shadow-md transition-all duration-200 border border-gray-100 dark:border-gray-700">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Minimizes diagnostic and treatment errors through comprehensive
                analysis of patient data and medical literature.
              </p>
            </div>
          </div>
        </div>
